...
namespace HallBooking.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Payid,Cardnumber,Amount,Paydate,Userid")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Payid,Cardnumber,Amount,Paydate,Userid")] Payment payment)
        {
            if (id != payment.Payid)
            {
                return NotFound();
